...
const axios = {
  post: (url, data) => {
    return new Promise(resolve => {
      setTimeout(() => {
        resolve({ data: { yield: Math.random() * 5 + 2 } });
      }, 1000);
    });
  }
};
            ...
            <div className="lg:col-span-2">
                <form onSubmit={handleGetEstimate} className="bg-white p-6 rounded-xl shadow-lg space-y-4">
                    ...
                    <div>
                     ...
                     <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">{T.common.area} 🌾</label>
                        <input name='Area' onChange={handleInfoChange} value={farmInfo.Area} type="number" placeholder={T.dashboard.areaPlaceholder} className="w-full input-style" required />
                    </div>
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">{T.dashboard.rainfall} 🌧️</label>
                        <input name='Annual_Rainfall' onChange={handleInfoChange} value={farmInfo.Annual_Rainfall} type="number" placeholder={T.dashboard.rainfallPlaceholder} className="w-full input-style" required />
                    </div>
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">{T.dashboard.fertilizer} 💊</label>
                        <input name='Fertilizer_Per_Hectare' onChange={handleInfoChange} value={farmInfo.Fertilizer_Per_Hectare} type="number" placeholder={T.dashboard.fertilizerPlaceholder} className="w-full input-style" required />
                    </div>
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">{T.dashboard.pesticide} 🐛</label>
                        <input name='Pesticide_Per_Hectare' onChange={handleInfoChange} value={farmInfo.Pesticide_Per_Hectare} type="number" placeholder={T.dashboard.pesticidePlaceholder} className="w-full input-style" required />
                    </div>
            ...
            <div className="lg:col-span-3">
                ...
                {prediction !== null && (
                    <div className="bg-white p-6 rounded-xl shadow-lg mb-8 text-center">
                        ...
                        <p className="text-lg text-gray-700">{T.dashboard.tonsPerHectare}</p>
                    </div>
                )}
